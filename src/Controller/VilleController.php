...
class VilleController extends AbstractController
{
    ...
    #[Route('/{nom}', name: 'app_ville_show', methods: ['GET'])]
    ...
    #[Route('/{nom}/edit', name: 'app_ville_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{nom}', name: 'app_ville_delete', methods: ['POST'])]
    public function delete(Request $request, Ville $ville, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$ville->getNom(), $request->request->get('_token'))) {
